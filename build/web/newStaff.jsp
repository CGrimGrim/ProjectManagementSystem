...
Contact Number:&nbsp;<input type="tel" name="contact_num"><br><br>
Contract Type:&nbsp;<input type="text" name="contract_type"><br><br>
Number of Hours:&nbsp;<input type="text" name="contract_hours"><br><br>
<input type="submit" value="Submit">
</form>
<br>
<br>
